> Для удобного просмотра лучше скачайте репозиторий или клонируйте с помощью Git и откройте как хранилище в приложении [Obsidian](https://obsidian.md/) (если на ПК и мобилки)
# План занятий 
1. [[Вводное занятие]]
